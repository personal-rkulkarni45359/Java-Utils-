...
public class JFileRenamer {
	...
	{
		JFileRenamer namer = new JFileRenamer(JConstants.INPUT_IMAGE_DIRECTORY, JFileRenamer.SORT_FILES_ALPHANUMERIC);
	}

	 JFileRenamer(String directoryName, int sort_option) throws IOException  
	 {
	...
	public void standardize(String prefix) throws IOException {
		...
		for (String fileName : files) 
		{
			...
			File newFile = new File(JConstants.OUTPUT_IMAGE_DIRECTORY + newFilename);
